...
import { ViewState, Observation, ResumeSection } from '../../types';
  ...
  const resumeSections: ResumeSection[] = [
      {
          ...
          content: { name: '张三', role: '高级前端工程师', contact: '138-0000-0000 · zhangsan@email.com', loc: '北京 · 望京' }
      },
      {
      ...
      <div className="bg-white/90 backdrop-blur-md border-b border-slate-200 px-6 h-16 flex items-center justify-between shrink-0 z-30 sticky top-0">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
             ...
             <div>
                 <h2 className="text-base font-bold text-slate-900 leading-tight">张三</h2>
