...
const AGENT_ACTIVITIES = [
    { text: "正在面试候选人 王五 (05:23)...", icon: Phone, color: "text-indigo-600", bg: "bg-indigo-50/60", border: "border-indigo-100", dot: "bg-indigo-500" },
    { text: "正在生成 钱七 的面试分析报告 (89%)...", icon: Loader2, color: "text-amber-600", bg: "bg-amber-50/60", border: "border-amber-100", dot: "bg-amber-500", spin: true },
    { text: "正在呼叫候选人 孙九 (第1次尝试)...", icon: Radio, color: "text-emerald-600", bg: "bg-emerald-50/60", border: "border-emerald-100", dot: "bg-emerald-500" },
                         ...
                         <div className="flex gap-6">
                             ...
                             <div className="space-y-3 pt-1">
                                 <div className="flex items-center gap-3">
                                     <h1 className="text-2xl font-bold text-slate-900">张三</h1>
                        ...
                        {[{ id: 'ALL', label: '全部' }, { id: 'PENDING', label: '待呼叫' }, { id: 'ACTIVE', label: '执行中' }, { id: 'COMPLETED', label: '已完成' }, { id: 'EXCEPTION', label: '需关注' }].map((t) => {
                            ...
                            return (
                                <button key={t.id} onClick={() => setFilter(t.id as FilterType)}
                                    className={`px-4 py-1.5 text-[13px] font-bold rounded-full transition-all duration-300 ${
                                        isActive 
